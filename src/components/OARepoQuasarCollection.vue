        ...
        <div v-if="!collectionLoading">
            ...
            <div class="row horiz wrap items-stretch" v-if="items.length > 0">  <!-- use 'row' class to define a container / parent -->
                ...
                <div class="aggs collection-facets">
                    ...
                    <slot name="facets-before" v-bind:aggregations="aggregations" v-bind:collection="collection">
                    </slot>
...
class OARepoCollection extends Vue {
    ...
    get collectionLoading() {
        return this.oarepo$.collectionModule.state !== 2;
    }
